# Worksheet 08 — Filtering unwanted, reactive, or warning motifs

## Context

Students use registry matches to identify potentially undesirable structures.

**Keywords:** structural alerts, reactive groups, filtering
...
owcheminf-cyclic-registry-fingerprint \
  ...
  --name-column name \
  --out-prefix outputs/worksheet_08_unwanted_motifs_crfp \
  --write-json
```
...
```text
outputs/worksheet_08_unwanted_motifs_crfp.active_bits.csv
outputs/worksheet_08_unwanted_motifs_crfp.matches.csv
outputs/worksheet_08_unwanted_motifs_crfp.summary.json
```
...
- Which compounds contain potentially problematic motifs?
- Which warnings are chemistry-dependent rather than absolute exclusions?
- How should you distinguish alerting motifs from false positives?
- How would you document a filtering rule?
