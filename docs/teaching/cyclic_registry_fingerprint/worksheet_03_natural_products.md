# Worksheet 03 — Cyclic motifs in natural-product-like compounds

## Context

Students profile cyclic and heteroatom-rich motifs that are common in natural products.

**Keywords:** natural products, alkaloids, flavonoids, ring systems
...
owcheminf-cyclic-registry-fingerprint \
  ...
  --name-column name \
  --out-prefix outputs/worksheet_03_natural_products_crfp \
  --write-json
```
...
```text
outputs/worksheet_03_natural_products_crfp.active_bits.csv
outputs/worksheet_03_natural_products_crfp.matches.csv
outputs/worksheet_03_natural_products_crfp.summary.json
```
...
- Which motifs are most common in the selected natural-product-like set?
- Are oxygen-containing rings more common than nitrogen-containing rings?
- Which compounds contain fused ring systems?
- How does registry coverage affect interpretation?
