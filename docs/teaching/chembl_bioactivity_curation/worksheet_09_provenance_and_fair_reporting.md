# Worksheet 09: Provenance and FAIR Reporting

## Context

Students document how the dataset was created.
...
```text
Any curation workflow → Data Table → Save Data
```
...
Write a reproducibility section describing target, filters, standardization, duplicate handling, and model input.
...
Could another student reproduce your dataset? What information is still missing?
