# Worksheet 03: Bioactivity Endpoints, Units, and Relations

## Context

Students distinguish IC50, Ki, Kd, EC50, pChEMBL, units, and relational operators.
...
Filter a small activity table by endpoint type, relation, and units.
...
Should values marked with > or < be used directly in regression? When is pChEMBL useful?
