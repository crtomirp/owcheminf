# Worksheet 01: What ChEMBL Bioactivity Data Represents

## Context

Students learn the meaning of target, compound, assay, document, and activity records.
...
Use target and activity example tables to identify the major entities in a bioactivity database.
...
Which field identifies the compound? Which field identifies the biological target? Why can one molecule have several activity values?
