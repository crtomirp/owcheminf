# Worksheet 04: Retrieving Bioactivity Data

## Context

Students retrieve bioactivities and export a raw table for reproducible curation.
...
Retrieve records for a selected target and save the raw output before filtering.
...
Why should raw downloaded data be saved before curation? Which metadata fields are essential?
