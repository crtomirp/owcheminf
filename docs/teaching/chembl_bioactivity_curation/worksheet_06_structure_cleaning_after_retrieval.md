# Worksheet 06: Molecular Structure Cleaning After Retrieval

## Context

Students standardize structures after ChEMBL retrieval.
...
```text
ChEMBL Bioactivity Retriever → Mol Standardizer → Data Table
```
...
Inspect salts, invalid structures, mixtures, and standardized SMILES.
...
Why should standardization happen before descriptor calculation? What should be recorded in the curation log?
