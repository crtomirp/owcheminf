# Worksheet 05: Assay and Confidence Filtering

## Context

Students design inclusion/exclusion rules for assay records.
...
```text
ChEMBL Bioactivity Retriever → Data Table
```
...
Apply filters for target confidence, assay type, standard type, relation, and data validity comments.
...
How strict should the filtering be? What is the trade-off between dataset size and data quality?
