# Worksheet 10: Reproducible Standardization Report

## Context

Students prepare a short report documenting their standardization protocol and decisions.
...
1. Choose a dataset and run `Mol Standardizer`.
2. Export the output table.
3. Summarize how many molecules changed, failed, or were unchanged.
4. Describe the selected widget settings.
5. Write a short reproducibility report including limitations.

## Guiding questions

- What information is needed to reproduce a cleaned dataset?
- Why should failed structures be reported?
- How would you version a standardized dataset?
