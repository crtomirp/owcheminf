# Worksheet 06: Aromaticity and Kekulization

## Context

Students compare aromatic and kekulized representations before cyclic registry fingerprinting.
...
1. Use benzene and pyridine aromatic/kekulized pairs.
2. Run `Mol Standardizer`.
3. Send output to `Cyclic Registry Fingerprint`.
4. Inspect `Matched Registry Entries`.
5. Discuss whether aromatic and kekulized forms are treated consistently.

## Guiding questions

- What is the difference between aromatic and kekulized SMILES?
- Why do databases sometimes store different representations of the same molecule?
- Why is this important for substructure matching?
